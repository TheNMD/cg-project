...
class TexSphere(object):
    def __init__(self, vert_shader, frag_shader):
        self.vertices, self.indices, self.colors, self.normals, self.texcoords = sphere([0.0, 0.0, 0.0], 2, 150, 150) # center, radius, stacks, sectors - Sphere with stacks and sectors
