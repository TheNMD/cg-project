...
def main():
    ...
    model_gouraud = Ellipsoid("./gouraud.vert", "./gouraud.frag").setup()
    viewer.add(model_gouraud)
    model_phong = Ellipsoid("./phong.vert", "./phong.frag").setup()
    viewer.add(model_phong)
    model_tex = TexEllipsoid("./textured/phong_texture.vert", "./textured/phong_texture.frag").setup()
